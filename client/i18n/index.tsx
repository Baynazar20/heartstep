...
const translations = {
  en: {
    ...
    hero: {
      ...
      a_sub: "Warm, trustworthy support for early communication—built with families and educators in mind.",
      b_sub: "Practical steps, playful practice, and caring community for early communication growth.",
      stats: { c1: "Caregiver confidence ↑", c2: "More peer interactions", c3: "Classrooms engaged" },
      trusted: "Trusted by families, educators, and therapists around the world",
      play: "Google Play",
    ...
    testimonials: { heading: "Feedbacks" },
  ...
  tm: {
    ...
    hero: {
      ...
      stats: { c1: "Hossarlaryň ynamy ↑", c2: "Has köp deň-duşlar bilen gatnaşygy", c3: "Synplar gatnaşdy" },
  ...
  ru: {
    ...
    hero: {
      title: "Помогаем маленьким сердцам обрести голос",
      a_sub: "Т��плая и надёжная поддержка ранней коммуникации для семей и педагогов.",
      b_sub: "Практичные шаги, игра и заботливое сообщество для развития общения.",
      stats: { c1: "Уверенность заботящихся ↑", c2: "Больше общения со сверстниками", c3: "Задействованные классы" },
      trusted: "Нам доверяют семьи, педагоги и терапевты по всему миру",
      play: "Google Play",
    ...
    problem: {
      ...
      items: {
        one: { stat: "1 из 5", label: "Дети сталкиваются с трудностями общения" },
        two: { stat: "3x", label: "Лучшие результаты при ранней поддержке" },
        three: { stat: "90%", label: "Семьи отмечают рост уверенности" },
      },
    },
    ...
    benefits: { heading: "Преимущества", items: [ { title: "Надёжность", desc: "Методы с доказанной эффективностью и теплом." }, { title: "Практичность", desc: "Шаги, которые подходят семейной жизни." }, { title: "Игра", desc: "Радостные занятия, которые любят дети." }, { title: "Сообщество", desc: "Поддержка для семей и педагогов." } ] },
    testimonials: { heading: "Отзывы" },
    team: { heading: "Наша команда" },
    impact: { heading: "Наше влияние", labels: { i1: "Поддержанных детей", i2: "Задействованные классы", i3: "Часы волонтёров" }, charts: { weekly: "Рост участия по неделям", confidence: "Уверенность заботящихся" } },
  ...
  ms: {
    ...
    hero: {
      ...
      a_sub: "Sokongan awal yang hangat dan dipercayai untuk keluarga dan pendidik.",
      b_sub: "Langkah praktikal, latihan menyeronokkan, dan komuniti yang prihatin.",
      stats: { c1: "Keyakinan penjaga ↑", c2: "Lebih interaksi rakan sebaya", c3: "Kelas yang terlibat" },
    ...
    testimonials: { heading: "Testimoni" },
